...
namespace COMP003B.FinalProject.PedroG.Controllers
{
    public class MechanicsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MechanicId,MechanicName,MechanicDescription,MechanicEmail,MechanicPhone")] Mechanic mechanic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MechanicId,MechanicName,MechanicDescription,MechanicEmail,MechanicPhone")] Mechanic mechanic)
        {
